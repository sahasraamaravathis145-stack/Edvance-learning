...
export default function Signup({ onComplete }: Props) {
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 mt-2">Start your AI-powered learning journey today.</p>
        </div>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-xl shadow-slate-200 border border-slate-100">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <span className="w-5 h-5 flex items-center justify-center"><Github className="w-5 h-5" /></span> GitHub
            </button>
            <button 
              onClick={handleSocialSignup}
              disabled={loading}
